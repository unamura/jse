...
public class DogEquality {
	...
	private static void consistency() {// spiega cosa è la consistenza
		Dog bob = new Dog("Bob", "Robert Barkright");// se è vero che bob è uguale al primo, deve essere uguale anche al
													 // secondo. Se ho verificato che una volta sono uguali, poi devono
													 // essere uguali sempre
		Dog[] others = { new Dog("Bob", "Robert Barkright"), new Dog("Bob", "William Barkright") };
